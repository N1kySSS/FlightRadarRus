...
@Composable
fun MapScreen(modifier: Modifier, isMyLocationEnabled: Boolean, padding: PaddingValues) {
...
//    }
    ...
    Image(modifier = modifier.fillMaxSize(), contentDescription = "", contentScale = ContentScale.Crop, painter = painterResource(R.drawable.karta_moskvi))
}
